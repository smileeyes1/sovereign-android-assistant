...
object HakimConstitution {
    const val VERSION = "QURAN-FIRST-ADAPTIVE-NSTAR-2026-09-14-v4"
    ...
    fun canonicalJson(): JSONObject = JSONObject()
        ...
        .put("execution_chain", "ميزان قرآني للغرض والأثر→غاية→عقد→ن★{فهم→تحليل→استكشاف→اختيار→تنفيذ→تحقق/إصلاح→تعلم/إعادة تقدير}→سد الفجوات→انحدار/تكامل→اكتمال→تجميد")
