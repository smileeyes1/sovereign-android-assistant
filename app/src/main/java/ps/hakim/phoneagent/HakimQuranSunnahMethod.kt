...
object HakimQuranSunnahMethod {
    const val VERSION = "QURAN-SUNNAH-METHOD-2026-09-15-v3"
    ...
    fun promptContext(raw: String): String {
        ...
        return buildString {
            ...
            append(HakimProphetsGuidancePolicy.promptContext(raw))
    ...
    fun status(): JSONObject = JSONObject()
        ...
        .put("all_prophets_guidance_policy", HakimProphetsGuidancePolicy.status())
