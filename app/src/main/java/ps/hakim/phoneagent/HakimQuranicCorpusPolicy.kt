...
object HakimQuranicCorpusPolicy {
    ...
    fun promptContext(raw: String): String {
        ...
        return buildString {
            ...
            appendLine("والتوسعة التفصيلية تحفظ الفصل نفسه: نص الوحي ≠ القراءات ≠ التجويد ≠ التفسير ≠ غريب القرآن ≠ أسباب النزول ≠ علوم القرآن ≠ بيانات السورة ≠ الترجمة ≠ الفقه والاستنباط.")
