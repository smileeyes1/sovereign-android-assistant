...
object HakimQuranicCorpusPolicy {
    ...
    fun promptContext(raw: String): String {
        ...
        return buildString {
            ...
            appendLine("العقد الأساسي المحفوظ: نص الوحي ≠ القراءات ≠ التفسير ≠ أسباب النزول ≠ بيانات السورة ≠ الاستنباط البشري.")
            appendLine("والتفصيل الأوسع: نص الوحي ≠ الرسم والضبط وعدّ الآي ≠ القراءات ≠ التجويد والوقف والابتداء ≠ التفسير ≠ أسباب النزول ≠ المكي والمدني وتاريخ النزول ≠ بيانات السور ومقاصدها ≠ المحكم والمتشابه ≠ دعاوى النسخ ≠ غريب القرآن واللغة ≠ الإعراب والبلاغة والنظم ≠ أحكام القرآن والاستنباط الفقهي ≠ المناسبات ≠ تاريخ جمع المصحف ونقله ≠ الترجمات والتقريبات التفسيرية ≠ الاستنباط البشري.")
