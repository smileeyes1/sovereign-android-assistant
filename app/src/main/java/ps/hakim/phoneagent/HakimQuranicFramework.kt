 ...
 * القرآن أصل الهداية والميزان القيمي والشرعي، والسنة الصحيحة بيان وهدي،
...
object HakimQuranicFramework {
    ...
    fun promptContext(raw: String): String {
        ...
        return buildString {
            ...
            appendLine("في الطب والهندسة والحساب والإدارة والبرمجة وسائر الوسائل الدنيوية: استخدم العقل والعلم والتجربة والخبرة والمصادر الموثوقة لاختيار السبب الأنسب؛ هذه أدوات تحت الهداية وليست بدائل عنها، ولا تنسب نتيجة تقنية أو تجريبية إلى القرآن بلا دليل.")
    ...
    private val worldlyMeansRegex = Regex(
        "(?i)(برمجة|كود|تقني|هندسة|طب|دواء|حساب|رياضيات|إدارة|ادارة|ملف|متصفح|تطبيق|موقع|شبكة|تعليم|جدول|تصميم|بناء|اختبار|سيارة|كهرباء|اقتصاد|زراعة|صناعة)"
    )
}
