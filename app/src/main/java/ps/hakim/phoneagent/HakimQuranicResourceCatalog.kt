...
object HakimQuranicResourceCatalog {
    ...
    val resources: List<Resource> = listOf(
        Resource(
            "KFGQPC_HAFS_SMART_V6",
            "خط الرسم العثماني — رواية حفص — للأجهزة الذكية",
            Kind.MUSHAF_TEXT,
            "حفص عن عاصم",
            "53d82b553e5fe919ca1a732e35bf4eb0",
            "1dbeae3847880b1c21a956dcfdc0a2d9d490e729",
            false
        ),
        Resource(
            "KFGQPC_HAFS_UNICODE_V13",
            "خط الرسم العثماني — رواية حفص — Unicode",
            Kind.MUSHAF_TEXT,
            "حفص عن عاصم",
            "cf6841aea5b1d1fd70d032b43ff08278",
            "36ea5ab0d7ea1702f17ff43f9b50924cccd77ebf",
            false
        ),
        Resource(
            "KFGQPC_WARSH_UNICODE",
            "خط الرسم العثماني — رواية ورش",
            Kind.QIRAAT,
            "ورش عن نافع",
        ...
        Resource(
            "KFGQPC_SHUBAH_UNICODE",
            "خط الرسم العثماني — رواية شعبة",
            Kind.QIRAAT,
            "شعبة عن عاصم",
            "5cda29121bf0d7234e039002e1fbf600",
            "8d66bdf0cab96dc7d1032792c19f77980ca6682a",
            false
        ),
        Resource(
            "KFGQPC_QALOUN_UNICODE",
            "خط الرسم العثماني — رواية قالون",
            Kind.QIRAAT,
            "قالون عن نافع",
            "964208ff04c8aadd3ddc1be262d8cfd3",
            "81733666be17742e13c9fa4c7d26d42b1adc67c8",
            false
        ),
        Resource(
            "KFGQPC_DOURI_UNICODE",
            "خط الرسم العثماني — رواية الدوري",
            Kind.QIRAAT,
            "الدوري عن أبي عمرو",
            "a60bdd18397b3e27e4617478968a35c8",
            "8049482f04b4ff1053a7859f96b2b113b9771efb",
            false
        ),
        Resource(
            "KFGQPC_SOUSI_UNICODE",
            "خط الرسم العثماني — رواية السوسي",
            Kind.QIRAAT,
            "السوسي عن أبي عمرو",
            "1bf6023e29b7622a52b6171232c17096",
            "e52dbc6d8b43797a8faa0fd1ec1d8e5000265674",
            false
        ),
        Resource(
            "KFGQPC_TAFSIR_MUYASSAR",
            "التفسير الميسر للقرآن الكريم",
            Kind.TAFSIR,
            null,
            "5601682965e32f4dd6992c7600fdccc3",
            "5f533113c2f54f32eded734bb49e6a5837965722",
            true
        ),
        Resource(
            "KFGQPC_GHAREEB_MUYASSAR",
            "الميسر في غريب القرآن الكريم",
            Kind.GHAREEB,
            null,
            "7e22381eedb152ee7ed6488f2395c6cd",
            "055a908c6ec7f06912c33bd00920406c665cc5f9",
            true
        ),
        Resource(
            "KFGQPC_TAJWEED_MUYASSAR",
            "التجويد الميسر",
            Kind.TAJWEED,
            null,
            "b4a265a810c0ce4a722019791910b67e",
            "d2496382fc5e843ccb693b94dd19407eaa174bea",
            true
        )
    )
