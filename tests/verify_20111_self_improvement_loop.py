...
req(state["android"]["field_observed_current"]["evidence"] in {"signed_health_on_stateless_pairing","authenticated_direct_status_probe","authenticated_direct_status_probe_with_lan_survey","authenticated_direct_status_probe_version_20310"}, "field_observed_evidence")
