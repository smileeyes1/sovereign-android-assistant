...
req("verified-teacher-artifacts" in BUILD or "universal-artifact-pipeline" in BUILD or "final-installable" in BUILD or "hardening-train" in BUILD,"version_name")
