...
req('android.permission.REQUEST_INSTALL_PACKAGES' in MANIFEST,"self_update_request_install_permission_missing")
req('android.permission.UPDATE_PACKAGES_WITHOUT_USER_ACTION' in MANIFEST,"self_update_no_user_action_declaration_missing")
