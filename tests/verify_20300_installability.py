...
req(relation in {f"UPGRADE_FROM_ANY_KNOWN_202XX_BUILD_TO_{code}", f"UPGRADE_FROM_VERIFIED_20306_TO_{code}", f"UPGRADE_FROM_VERIFIED_20308_TO_{code}", f"UPGRADE_FROM_VERIFIED_20309_TO_{code}"},"install_relation")
