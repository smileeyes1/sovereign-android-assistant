...
req(state["android"]["latest_source_parent"]["commit"] == "04a2d9e9ccb3c6e8166a4bba23cb23f17fc62f36", "source_parent")
req(state["android"]["latest_source_parent"]["ci_run_number"] == 918, "source_parent_ci")
req(state["android"]["candidate"]["version_code"] == candidate == 20111, "candidate_version")
