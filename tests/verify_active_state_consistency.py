...
req(state["productization"]["resilient_connectivity_v2"] is True, "resilient_connectivity_v2")
req(state["productization"]["validated_network_truth"] is True, "validated_network_truth")
req(state["productization"]["connection_freshness_lease"] is True, "connection_freshness_lease")
req(state["productization"]["offline_store_and_forward"] is True, "offline_store_and_forward")
req(state["productization"]["cached_command_catchup"] is True, "cached_command_catchup")
req(state["productization"]["offline_field_verified"] is False, "offline_field_must_remain_false")
