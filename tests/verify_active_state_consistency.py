...
req(state["android"]["latest_source_parent"]["commit"] == "b01047f70e2985cbbe8a6d6a88d238095662648b", "source_parent")
req(state["android"]["latest_source_parent"]["ci_run_number"] == 927, "source_parent_ci")
req(state["android"]["candidate"]["version_code"] == candidate == 20112, "candidate_version")
