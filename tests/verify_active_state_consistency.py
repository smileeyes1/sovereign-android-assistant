...
req(state["cloud"]["last_verified_baseline_commit"] == "03b19fedb4ea42dea34baeffdf0840c2c865f684", "cloud_baseline")
...
req(state["android"]["candidate"]["version_code"] == candidate == 20306, "candidate_version")
...
req(state["local_execution"]["phone_channel"] == "OFFLINE_CURRENTLY", "phone_claim")
...
req(state["productization"]["candidate_version"] == candidate == 20306, "product_candidate")
...
req(state["productization"]["control_channel_field_verified"] is False, "control_channel_field_must_remain_false")
