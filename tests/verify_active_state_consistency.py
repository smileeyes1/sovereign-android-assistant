...
req(state["android"]["latest_source_parent"]["commit"] == "7396317ccc0a5c2eaf34ac5dc061d3c4d49ac821", "source_parent")
req(state["android"]["latest_source_parent"]["ci_run_number"] == 1156, "source_parent_ci")
req(state["android"]["candidate"]["version_code"] == candidate == 20309, "candidate_version")
...
req(state["productization"]["candidate_version"] == candidate == 20309, "product_candidate")
