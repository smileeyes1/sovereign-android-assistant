...
req(state["android"]["latest_source_parent"]["commit"] == "f9c4af943384cbd1b28fc6616ee385c1417080b6", "source_parent")
req(state["android"]["latest_source_parent"]["ci_run_number"] == 1029, "source_parent_ci")
req(state["android"]["candidate"]["version_code"] == candidate == 20301, "candidate_version")
...
req(state["productization"]["candidate_version"] == 20301, "product_candidate")
