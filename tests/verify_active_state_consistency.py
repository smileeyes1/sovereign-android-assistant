...
req(state["android"]["latest_source_parent"]["commit"] == "31a6366ad092ea4ff108bb5782f8d671ef3568ee", "source_parent")
req(state["android"]["latest_source_parent"]["ci_run_number"] == 1014, "source_parent_ci")
req(state["android"]["candidate"]["version_code"] == candidate == 20206, "candidate_version")
...
req(state["productization"]["candidate_version"] == 20206, "product_candidate")
...
req(state["local_artifacts"]["structured_spec_required"] is True, "structured_spec")
req(state["local_artifacts"]["worksheet_generic_pdf_fallback"] is False, "worksheet_generic_fallback")
req(state["local_artifacts"]["raw_model_dump_forbidden"] is True, "raw_model_dump")
req(state["productization"]["worksheet_generic_pdf_fallback"] is False, "product_worksheet_fallback")
