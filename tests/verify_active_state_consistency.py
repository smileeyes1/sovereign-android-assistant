...
req(state["android"]["latest_source_parent"]["commit"] == "f6a87d000936b248faee3fb40129f22a88ed720a", "source_parent")
req(state["android"]["latest_source_parent"]["ci_run_number"] == 1015, "source_parent_ci")
req(state["android"]["candidate"]["version_code"] == candidate == 20207, "candidate_version")
...
req(state["productization"]["candidate_version"] == 20207, "product_candidate")
