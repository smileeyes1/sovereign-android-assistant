...
req(state["android"]["latest_source_parent"]["commit"] == "e8bd8b0a668e26f4487e88a59a0a9c9b6ab1cf3c", "source_parent")
req(state["android"]["latest_source_parent"]["ci_run_number"] == 1021, "source_parent_ci")
req(state["android"]["candidate"]["version_code"] == candidate == 20300, "candidate_version")
