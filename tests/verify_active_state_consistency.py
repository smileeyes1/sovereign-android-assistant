...
req(state["android"]["candidate"]["version_code"] == candidate == 20311, "candidate_version")
...
req(state["android"]["field_observed_current"]["evidence"] in {"authenticated_direct_status_probe","authenticated_direct_status_probe_with_lan_survey","authenticated_direct_status_probe_version_20310"}, "field_observed_evidence")
...
req(state["productization"]["candidate_version"] == candidate == 20311, "product_candidate")
