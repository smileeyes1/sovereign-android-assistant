...
req(state["android"]["latest_source_parent"]["commit"] == "18db7a9234681ce0f887965d1bb7ace261756f6a", "source_parent")
req(state["android"]["latest_source_parent"]["ci_run_number"] == 1087, "source_parent_ci")
req(state["android"]["candidate"]["version_code"] == candidate == 20303, "candidate_version")
...
req(state["productization"]["candidate_version"] == 20303, "product_candidate")
