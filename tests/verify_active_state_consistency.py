...
req(state["android"]["latest_source_parent"]["commit"] == "0dddf549281865dca3bb342acf81b160a0505348", "source_parent")
req(state["android"]["latest_source_parent"]["ci_run_number"] == 986, "source_parent_ci")
req(state["android"]["candidate"]["version_code"] == candidate == 20202, "candidate_version")
...
req(state["productization"]["candidate_version"] == 20202, "product_candidate")
