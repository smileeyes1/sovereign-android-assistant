...
req(state["android"]["field_observed_current"]["evidence"] in {"authenticated_direct_status_probe","authenticated_direct_status_probe_with_lan_survey"}, "field_observed_evidence")
