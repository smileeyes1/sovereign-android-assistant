...
req(state["android"]["latest_source_parent"]["commit"] == "cfb2cf668a2f4431c3706a1b6d6d32bb5a9a8c76", "source_parent")
req(state["android"]["latest_source_parent"]["ci_run_number"] == 903, "source_parent_ci")
req(state["android"]["candidate"]["version_code"] == candidate == 20109, "candidate_version")
...
req(state["local_execution"]["phone_channel"] == "NOT_PROVEN_CURRENTLY", "phone_claim")
