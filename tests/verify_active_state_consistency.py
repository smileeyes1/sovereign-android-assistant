...
req(state["android"]["latest_source_parent"]["commit"] == "17949285373497924aff9a1e3e204292585a51f5", "source_parent")
req(state["android"]["latest_source_parent"]["ci_run_number"] == 940, "source_parent_ci")
req(state["android"]["candidate"]["version_code"] == candidate == 20204, "candidate_version")
...
req(state["productization"]["candidate_version"] == 20204, "product_candidate")
