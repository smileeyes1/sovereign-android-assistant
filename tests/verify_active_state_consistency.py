...
req(state["android"]["latest_source_parent"]["commit"] == "660cb075eb56608db7498cc32d72fd1969a9b905", "source_parent")
req(state["android"]["latest_source_parent"]["ci_run_number"] == 1154, "source_parent_ci")
req(state["android"]["candidate"]["version_code"] == candidate == 20308, "candidate_version")
...
req(state["productization"]["candidate_version"] == candidate == 20308, "product_candidate")
