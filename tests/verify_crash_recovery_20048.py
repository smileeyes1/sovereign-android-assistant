...
req(field>=20049,"سياسة الميدان أقدم من أحدث دليل مباشر مثبت")
req(policy.get("field_evidence",{}).get("version_code")==field,"دليل الميدان لا يطابق current_field_version")
req(policy.get("field_evidence",{}).get("signer_sha256")==policy["certificate_sha256"],"دليل الميدان لا يطابق موقّع D1 الحاكم")
req(candidate>field,"مرشح الإصلاح يجب أن يزيد عن خط الميدان")
