...
for x in ["EFFECT_VERIFIED","PROVEN_GATE","tool_success_is_not_goal_success","hypothetical_gate_forbidden","failure_requires_reroute","canClose","continue_until_effect_or_proven_gate"]: assert x in s,x
