...
require(center, "showAttachmentChooser", "attachment_picker_not_wired")
require(center, "mediaPickerLauncher", "photo_picker_not_wired")
require(center, "documentPickerLauncher", "document_picker_launcher_not_wired")
