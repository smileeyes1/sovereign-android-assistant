...
req("ربط خدمة الذكاء" in HOME and "اختبار الاتصال" in HOME, "product_intelligence_setup_missing")
req("OpenRouter المجاني" not in HOME and "مفتاح OpenRouter" not in HOME, "provider_jargon_leaked")
req("تأسيس ADB المحلي" not in HOME and "متصفح حكيم" not in HOME, "developer_controls_leaked")
