...
require("Phase.CANCELLED" in one and '"cancelled"' in one and "HakimSovereignOneKernel.frame" in sovereign, "P0: النواة السيادية الواحدة لا تمنع استئناف المهمة الملغاة")
